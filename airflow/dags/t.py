...
def load_and_clean():
    ...
    df = pd.read_csv('/opt/airflow/dags/IMDB Dataset.csv')
...
def train_model():
    ...
    joblib.dump(vectorizer, '/opt/airflow/dags/tfidf_vectorizer.pkl')
    joblib.dump(model, '/opt/airflow/dags/sentiment_model.pkl')
